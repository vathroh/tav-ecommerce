<template>
    <div class="featured-car bg-grea-2 content-area mt-50">
        <div class="container">
            <!-- Main title -->
            <div class="main-title-4">
                <h1>Galeri TAV Mobil</h1>
                <p>Menyediakan kualitas mobil bekas Terbaik, demi kenyamanan & kepuasan Anda</p>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100"
                                                :src="'https://admin.tavmobil.id/storage/car/details/' + item.image_feature1"
                                                alt="car">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100"
                                                :src="'https://admin.tavmobil.id/storage/car/details/' + item.image_feature2"
                                                alt="car">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100"
            ...
            <div class="main-title-2">
                ...
                <div class="row">
                    <div class="col mt-5 text-center">
                        <router-link id="menu3" :to="{ name: 'Beli' }">
                            <button class="btn button-theme btn-sm">Lihat lebih banyak</Button>
                        </router-link>
                    </div>
                </div>
            </div>
