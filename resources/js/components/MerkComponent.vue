        ...
        <div class="latest-offers categories content-area bg-grea mt-50">
            <div class="container">
                <div class="main-title">
                    <h1>Beli Mobil Berdasarkan Brand/Merk</h1>
                </div>  
                <div class="faq-info">
                    <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                        <li class="nav-item" style="margin-right: 10px;">
                            <button @click.prevent="back" class="nav-link" href="" id="navbarDropdownMenuLink7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Kembali
                            </button>
                        </li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-lg-4" v-for="item in dataMobil">
                            <div class="car-box">
